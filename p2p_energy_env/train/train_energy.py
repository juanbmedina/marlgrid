...
from p2p_energy_env.base_env.energy_wrapper import RLlibEnergyEnv  # Make sure this registers your env in ENV_REGISTRY
...
env = marl.make_env(environment_name="energy", map_name="energy_market", force_coop=True)
